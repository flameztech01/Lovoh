// screens/BizzzedSignup.jsx - Phone number field before Google signup
...
const BizzzedSignup = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      toast.success(`Welcome to Bizzzed, ${res.name || 'Creator'}! 🎉`);
      navigate(redirect);
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-100 px-4 py-4">
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <img src="/biizzed.png" alt="Bizzzed" className="h-8 w-auto" />
          <div className="w-9" />
        </div>
      </div>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              {step === 'phone' ? 'Join Bizzzed' : 'Verify with Google'}
            </h1>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            By signing up, you agree to Bizzzed's{' '}

// screens/BizzzedVideoDetail.jsx - Fixed Follow Functionality
...
const BizzzedVideoDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <Helmet>
        <title>{video.title} | Bizzzed</title>
                ...
                <div className="mt-4 p-4 bg-gray-50 rounded-xl">
                  {video.description ? (
                    ...
                    <p className="text-sm text-gray-500 italic">
                      This is a YouTube video shared on Bizzzed. 
                      <a
                        href={video.youtubeUrl}
                        target="_blank"
                        rel="noopener noreferrer"
...
export default BizzzedVideoDetail;
// screens/BizzzedMagazines.jsx - Social Media Style
                  ...
                  <div className="relative aspect-[3/4] overflow-hidden bg-gray-100">
                    {magazine.coverImage ? (
                      ...
                      <div className="w-full h-full bg-[#1B3766] flex items-center justify-center">
                        <span className="text-white text-xl font-bold">Bizzzed</span>
                      </div>
                    )}
                ...
                >
                  <div className="w-20 h-28 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                    {magazine.coverImage ? (
                      ...
                      <div className="w-full h-full bg-[#1B3766] flex items-center justify-center">
                        <span className="text-white text-xs font-bold">Bizzzed</span>
                      </div>
                    )}
                  </div>

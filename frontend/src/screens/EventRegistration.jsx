...
const EventRegistration = () => {
  ...
  if (isLoading) return (<div className="min-h-screen bg-gray-50"><Header /><div className="flex justify-center items-center h-96 pt-20"><FaSpinner className="w-12 h-12 text-[#1B3766] animate-spin" /></div><Footer /></div>);
  if (!event) return (<div className="min-h-screen bg-gray-50"><Header /><div className="max-w-4xl mx-auto px-4 py-20 pt-24 text-center"><h1 className="text-2xl font-bold text-gray-900 mb-2">Event Not Found</h1><Link to="/events" className="inline-flex items-center gap-2 px-6 py-2 bg-[#1B3766] text-white rounded-xl"><FaArrowLeft /> Browse Events</Link></div><Footer /></div>);
  if (!canRegister) return (<div className="min-h-screen bg-gray-50"><Header /><div className="max-w-4xl mx-auto px-4 py-20 pt-24 text-center"><h1 className="text-2xl font-bold text-gray-900 mb-2">Registration Closed</h1><p className="text-gray-600 mb-6">This event is no longer accepting registrations.</p><Link to={`/events/${id}`} className="inline-flex items-center gap-2 px-6 py-2 bg-[#1B3766] text-white rounded-xl"><FaArrowLeft /> Back to Event</Link></div><Footer /></div>);

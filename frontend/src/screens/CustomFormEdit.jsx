// screens/CustomFormEdit.jsx - With Mobile Field Modal
...
const CustomFormEdit = () => {
  ...
  const { data: form, isLoading: formLoading } = useGetCustomFormByIdQuery(id);
  const [updateForm, { isLoading: isUpdating }] = useUpdateCustomFormMutation();
      ...
      <div className="lg:ml-[280px] p-4 md:p-6">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6 bg-white rounded-xl p-4 shadow-sm border border-gray-200">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate(`/custom-form/${id}`)}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <FaSave className="text-xs" /> {isUpdating ? "Saving..." : "Save"}
            </button>
          </div>
        </div>
                ...
                {fields.length === 0 && (
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 border-dashed p-12 text-center">
                    ...
                    <p className="text-sm text-gray-500">
                      Use the left panel or tap + button
                    </p>
                  </div>
                )}
              </div>

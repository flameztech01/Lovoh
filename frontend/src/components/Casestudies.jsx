      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Proven Results{" "}
            <span className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent">Case Studies</span>
          </h2>
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className={`w-full py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 ${
                  study.color.includes('254899') 
                    ? 'bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 hover:shadow-lg text-white'
        ...
        {/* Stats Section - Updated with blue gradient */}
        <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-3xl p-8 lg:p-12 text-white">

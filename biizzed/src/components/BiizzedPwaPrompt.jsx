...
const BiizzedPwaPrompt = () => {
  ...
  useEffect(() => {
    ...
    const dismissed = localStorage.getItem('biizzed-pwa-dismissed');
    if (dismissed) return;
  ...
  const handleInstall = async () => {
    ...
    setShowPrompt(false);
    localStorage.setItem('biizzed-pwa-dismissed', 'true');
  };
        ...
        {isIOS ? (
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
              ...
              <p className="text-xs text-gray-600">
                Install Biizzed for a faster, app-like experience
              </p>
            </div>
            <button
...
export default BiizzedPwaPrompt;
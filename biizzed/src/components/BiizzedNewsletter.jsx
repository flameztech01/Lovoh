// components/BiizzedNewsletter.jsx
...
const BiizzedNewsletter = () => {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      await subscribe({ email, name }).unwrap();
      setIsSubscribed(true);
      setEmail('');
      setName('');
      toast.success('Successfully subscribed to Biizzed Magazine!');
    } catch (error) {
          ...
          {!isSubscribed ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-200 mb-4 max-w-md mx-auto text-sm">
                Thank you for subscribing to Biizzed Magazine. Get ready for premium insights in your inbox.
              </p>
              <button
...
export default BiizzedNewsletter;
// components/ShopNavbar.jsx – Added brands grid dropdown
  ...
  return (
    <>
              ...
              <div className="h-16 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <Link to="/shop" className="flex items-center gap-2 group">
                    <img src="/uduua.png" alt="Logo" className="h-8 w-auto object-contain transition-transform group-hover:scale-105 duration-200" />
                  </Link>
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                  ...
                  <Link to="/shop/cart" className="relative flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-[#0043FC] transition-colors duration-200">
                  ...
                  <div className="relative" ref={brandsRef}>
                    <button
                      ...
                      className="flex items-center justify-center w-10 h-10 rounded-xl border border-gray-200 text-gray-600 hover:text-[#0043FC] hover:border-[#0043FC]/30 transition-all duration-200"
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {BRANDS.map((brand) => (
                            <button
                              ...
                              className="flex flex-col items-center justify-center p-3 rounded-xl hover:bg-[#0043FC]/5 transition-all duration-200"
                            >
                              <img
                                src={brand.icon}
                                alt={brand.name}
                  ...
                  {userInfo ? (
                    ...
                    <>
                      ...
                      <Link to="/shop/signup" className="text-sm font-semibold text-white bg-[#0043FC] hover:bg-[#0033cc] px-5 py-2 rounded-xl transition-colors duration-200">
                        Sign Up
                      </Link>
                    </>
                  )}
      ...
      <div className={`fixed inset-0 z-50 md:hidden transition-all duration-300 ${isMobileMenuOpen ? 'visible' : 'invisible'}`}>
        ...
        <div className={`absolute right-0 top-0 bottom-0 w-80 bg-white shadow-2xl transition-transform duration-300 transform ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          ...
          <div className="p-4 space-y-2 overflow-y-auto max-h-[calc(100vh-200px)]">
            <Link to="/shop" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-[#0043FC] font-semibold rounded-xl hover:bg-gray-50 transition-all duration-200">
              <FaBars className="text-lg" />
              <span>All Products</span>
            </Link>
            <Link to="/shop" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
            ...
            {userInfo ? (
              <>
                <Link to="/shop/orders" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                ...
                {isApprovedSeller && (
                  <>
                    ...
                    <p className="px-4 py-1 text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Seller Dashboard</p>
                    <Link to="/seller/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                      <FaTachometerAlt className="text-lg" /> <span>Dashboard</span>
                    </Link>
                    <Link to="/seller/products" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                      <FaStore className="text-lg" /> <span>My Products</span>
                    </Link>
                    <Link to="/seller/orders" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                      <FaBox className="text-lg" /> <span>Seller Orders</span>
                    </Link>
                    <Link to="/seller/wallet" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                      <FaWallet className="text-lg" /> <span>Wallet</span>
                    </Link>
                    <Link to="/seller/payment-history" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                      <FaHistory className="text-lg" /> <span>Payment History</span>
                    </Link>
                  </>
                )}

                <button onClick={() => { handleLogout(); setIsMobileMenuOpen(false); }} className="w-full flex items-center gap-3 px-4 py-3 text-red-600 font-medium rounded-xl hover:bg-red-50 transition-all duration-200">
                  <FaSignOutAlt className="text-lg" /> <span>Logout</span>
                </button>
              </>
            ) : (
              <>
                <Link to="/shop/login" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
                  <FaUser className="text-lg" /> <span>Login</span>
                </Link>
                <Link to="/shop/signup" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center w-full px-4 py-3 mt-2 rounded-xl text-white font-semibold bg-[#0043FC] hover:bg-[#0033cc] transition-all duration-200">
                  Sign Up
                </Link>
              </>
            )}
            ...
            <div className="border-t border-gray-100 my-2"></div>
            <Link to="/shop/help" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
              <FaQuestionCircle className="text-lg" /> <span>Help Center</span>
            </Link>
            <Link to="/shop/cart" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 text-gray-700 font-medium rounded-xl hover:bg-gray-50 hover:text-[#0043FC] transition-all duration-200">
              <div className="relative">
                <FaShoppingCart className="text-lg" />
                {cartCount > 0 && (
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 border-t border-gray-100 bg-gray-50">
            ...
            <p className="text-[10px] text-center text-gray-400 mt-2">© 2024 Úduua. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>

// components/BizzzedArticlesGrid.jsx
...
const BizzzedArticlesGrid = () => {
  ...
  // Fetch ads for Bizzzed FEATURED placement (square ad in grid)
  ...
  // Fetch ads for Bizzzed BANNER placement (horizontal banner ad)
  ...
  const createAdvertiseAd = (placement) => ({
    _id: `advertise-bizzzed-${placement}`,
    title: 'Advertise With Bizzzed',
    ...
    ctaLink: 'https://wa.me/2348055766461?text=Hello%2C%20I%27m%20interested%20in%20advertising%20on%20Bizzzed',
    mediaType: 'image',
    image: '/campus1.jpg',
...
export default BizzzedArticlesGrid;